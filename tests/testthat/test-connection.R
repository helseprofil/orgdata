test_that("Connection to DB", {
  ...
  expect_equal(is_conn_db(.test = TRUE, check = FALSE), "F:/Forskningsprosjekter/PDB 2455 - Helseprofiler og til_/PRODUKSJON/STYRING/raw-khelse/raw-database_BE.accdb")
