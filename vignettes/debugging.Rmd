...
add the columns to municipality and county to the data. The difference between
this options and `aggreagate` argument in `make_file()` is that the argument
`aggregate = FALSE` will cease aggregating keeping the geographical level as in
