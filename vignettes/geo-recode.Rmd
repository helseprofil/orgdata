...
consist of previous codes and their new codes whenever available. For instance,
...
ie. 2022, is in colum `currentCode`. Any geo codes that have changed since 2017
...
argument `append = TRUE`. The table in the database will be named as
*kommune2022* if the data consist of geo codes up to 2022, ie. argument `to =
2022` and `typ = kommune`.
