...
using the main function. Otherwise you can follow the step for
[installation](https://helseprofil.github.io/orgdata/#installation) or cloning
user startup files ie. *seepafil.R* from `user` branch.
