...
It is advisable to mark the file with *KONTROLLERT* in the Access Database when
you have checked the output. This will ensure the next time you run
`make_file()` of the same file group will be much faster escaping
all the cleaning and recording processes.
...
aggregated unless it's changed during function call or you reset the options.
